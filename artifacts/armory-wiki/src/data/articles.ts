...
export const articles: Article[] = [
  ...
  },
  {
    ...
    title: 'Винтовка Мосина: модель в контексте эпохи',
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'Этика описания', paragraphs: ['Говорить об известных образцах ответственно — значит не романтизировать насилие и не путать узнаваемость с качественной оценкой. В G.U.N.S. это прежде всего источники, даты и контекст.'] },
    ],
